...
app.storageQueue("runOrderFromQueue", {
  // 1. Point it to your existing queue
  queueName: "valuationorderqueue",
  // 2. Must match the key in your local.settings.json
  connection: "AZURE_STORAGE_CONNECTION_STRING",
  handler: async (requestBody, context) => {
    context.log(`Order picked up from queue (valuationorderqueue) "${requestBody.orderRecordId}"`);
